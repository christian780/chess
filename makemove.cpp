...
#define HASH_CA(pos) (pos->posKey ^= CastleKeys[(pos->castlePerm)])
#define HASH_EP (pos->posKey ^= (PieceKeys[EMPTY][(pos->enPas)]))
#define HASH_SIDE (pos->posKey ^= (SideKey))
inline void hashPCE(S_BOARD* pos, int pce, int sq) {
    pos->posKey ^= PieceKeys[pce][sq];
}

inline void hashSide(S_BOARD* pos) {
    pos->posKey ^= SideKey;
}
...
/*
inline U64 hashPCE(S_BOARD *pos, int pce, int sq){

    return pos->posKey ^= PieceKeys[pce][sq];
}
*/
